  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed z-[60] right-6 bottom-32 w-[380px] max-w-[calc(100vw-2rem)] h-[560px] max-h-[calc(100vh-10rem)] border border-terminal-cyan bg-terminal-panel shadow-[0_0_30px_rgba(6,182,212,0.35)] transition-all duration-150 ${
      ...
      <button
        ...
        className="fixed z-[60] right-6 bottom-16 w-14 h-14 flex items-center justify-center bg-black border border-terminal-cyan text-terminal-cyan hover:bg-cyan-950 transition-all duration-100"
        style={{
          boxShadow: open
            ? "0 0 0 1px rgba(6,182,212,0.9), 0 0 22px rgba(6,182,212,0.7)"
            : "0 0 0 1px rgba(6,182,212,0.5), 0 0 14px rgba(6,182,212,0.45)",
        }}
      >
